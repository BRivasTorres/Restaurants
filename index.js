	...
	fetch("https://example-data.draftbit.com/restaurants")
		...
		.then((data) => {
			...
			container.innerHTML = data.map((restaurant) => {
				return `<div class="card-restaurant">
                    ...
                    <div class="card-restaurant-details">
                        <div class="country">
                            <p><span><i class="fa-solid fa-flag"></i></span>Contry:${restaurant.city}</p>
                        </div>
                        ...
                        <div class="address">
                            <p><span><i class="fa-solid fa-location-dot"></i></span>Address:${restaurant.address}</p>
                        </div>
                        <div class="website">
